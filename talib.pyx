...
def ACOS( np.ndarray[np.float_t, ndim=1] real ):
    ...
    cdef np.ndarray[np.float64_t, ndim=1] outreal = zeros(allocation, dtype=float64)
    TA_Initialize()
...
def AROON( np.ndarray[np.float_t, ndim=1] high , np.ndarray[np.float_t, ndim=1] low , timeperiod=-2**31 ):
    ...
    cdef int outbegidx
    cdef int outnbelement
    cdef np.ndarray[np.float64_t, ndim=1] outaroondown = zeros(allocation, dtype=float64)
    cdef np.ndarray[np.float64_t, ndim=1] outaroonup = zeros(allocation, dtype=float64)
    TA_Initialize()
...
def BBANDS( np.ndarray[np.float_t, ndim=1] real , timeperiod=-2**31 , nbdevup=-4e37 , nbdevdn=-4e37 , matype=0 ):
    ...
    cdef int outbegidx
    cdef int outnbelement
    cdef np.ndarray[np.float64_t, ndim=1] outrealupperband = zeros(allocation, dtype=float64)
    cdef np.ndarray[np.float64_t, ndim=1] outrealmiddleband = zeros(allocation, dtype=float64)
    cdef np.ndarray[np.float64_t, ndim=1] outreallowerband = zeros(allocation, dtype=float64)
    TA_Initialize()
...
def HT_PHASOR( np.ndarray[np.float_t, ndim=1] real ):
    ...
    cdef int outbegidx
    cdef int outnbelement
    cdef np.ndarray[np.float64_t, ndim=1] outinphase = zeros(allocation, dtype=float64)
    cdef np.ndarray[np.float64_t, ndim=1] outquadrature = zeros(allocation, dtype=float64)
    TA_Initialize()
...
def HT_SINE( np.ndarray[np.float_t, ndim=1] real ):
    ...
    cdef int outbegidx
    cdef int outnbelement
    cdef np.ndarray[np.float64_t, ndim=1] outsine = zeros(allocation, dtype=float64)
    cdef np.ndarray[np.float64_t, ndim=1] outleadsine = zeros(allocation, dtype=float64)
    TA_Initialize()
...
def MACD( np.ndarray[np.float_t, ndim=1] real , fastperiod=-2**31 , slowperiod=-2**31 , signalperiod=-2**31 ):
    ...
    cdef int outbegidx
    cdef int outnbelement
    cdef np.ndarray[np.float64_t, ndim=1] outmacd = zeros(allocation, dtype=float64)
    cdef np.ndarray[np.float64_t, ndim=1] outmacdsignal = zeros(allocation, dtype=float64)
    cdef np.ndarray[np.float64_t, ndim=1] outmacdhist = zeros(allocation, dtype=float64)
    TA_Initialize()
...
def MAMA( np.ndarray[np.float_t, ndim=1] real , fastlimit=-4e37 , slowlimit=-4e37 ):
    ...
    cdef int outbegidx
    cdef int outnbelement
    cdef np.ndarray[np.float64_t, ndim=1] outmama = zeros(allocation, dtype=float64)
    cdef np.ndarray[np.float64_t, ndim=1] outfama = zeros(allocation, dtype=float64)
    TA_Initialize()
...
def MINMAX( np.ndarray[np.float_t, ndim=1] real , timeperiod=-2**31 ):
    ...
    cdef int outbegidx
    cdef int outnbelement
    cdef np.ndarray[np.float64_t, ndim=1] outmin = zeros(allocation, dtype=float64)
    cdef np.ndarray[np.float64_t, ndim=1] outmax = zeros(allocation, dtype=float64)
    TA_Initialize()
...
def STOCH( np.ndarray[np.float_t, ndim=1] high , np.ndarray[np.float_t, ndim=1] low , np.ndarray[np.float_t, ndim=1] close , fastk_period=-2**31 , slowk_period=-2**31 , slowk_matype=0 , slowd_period=-2**31 , slowd_matype=0 ):
    ...
    cdef int outbegidx
    cdef int outnbelement
    cdef np.ndarray[np.float64_t, ndim=1] outslowk = zeros(allocation, dtype=float64)
    cdef np.ndarray[np.float64_t, ndim=1] outslowd = zeros(allocation, dtype=float64)
    TA_Initialize()
...
def STOCHF( np.ndarray[np.float_t, ndim=1] high , np.ndarray[np.float_t, ndim=1] low , np.ndarray[np.float_t, ndim=1] close , fastk_period=-2**31 , fastd_period=-2**31 , fastd_matype=0 ):
    ...
    cdef int outbegidx
    cdef int outnbelement
    cdef np.ndarray[np.float64_t, ndim=1] outfastk = zeros(allocation, dtype=float64)
    cdef np.ndarray[np.float64_t, ndim=1] outfastd = zeros(allocation, dtype=float64)
    TA_Initialize()
