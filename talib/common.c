 ...
 */
  ...
  if (PyDict_SetItem(__pyx_t_2, __pyx_int_0, __pyx_n_s_Success) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (PyDict_SetItem(__pyx_t_2, __pyx_int_1, __pyx_kp_s_Library_Not_Initialized_TA_LIB_N) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (PyDict_SetItem(__pyx_t_2, __pyx_int_2, __pyx_kp_s_Bad_Parameter_TA_BAD_PARAM) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (PyDict_SetItem(__pyx_t_2, __pyx_int_3, __pyx_kp_s_Allocation_Error_TA_ALLOC_ERR) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (PyDict_SetItem(__pyx_t_2, __pyx_int_4, __pyx_kp_s_Group_Not_Found_TA_GROUP_NOT_FOU) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (PyDict_SetItem(__pyx_t_2, __pyx_int_5, __pyx_kp_s_Function_Not_Found_TA_FUNC_NOT_F) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (PyDict_SetItem(__pyx_t_2, __pyx_int_6, __pyx_kp_s_Invalid_Handle_TA_INVALID_HANDLE) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (PyDict_SetItem(__pyx_t_2, __pyx_int_7, __pyx_kp_s_Invalid_Parameter_Holder_TA_INVA) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (PyDict_SetItem(__pyx_t_2, __pyx_int_8, __pyx_kp_s_Invalid_Parameter_Holder_Type_TA) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (PyDict_SetItem(__pyx_t_2, __pyx_int_9, __pyx_kp_s_Invalid_Parameter_Function_TA_IN) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (PyDict_SetItem(__pyx_t_2, __pyx_int_10, __pyx_kp_s_Input_Not_All_Initialized_TA_INP) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (PyDict_SetItem(__pyx_t_2, __pyx_int_11, __pyx_kp_s_Output_Not_All_Initialized_TA_OU) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (PyDict_SetItem(__pyx_t_2, __pyx_int_12, __pyx_kp_s_Out_of_Range_Start_Index_TA_OUT) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (PyDict_SetItem(__pyx_t_2, __pyx_int_13, __pyx_kp_s_Out_of_Range_End_Index_TA_OUT_OF) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (PyDict_SetItem(__pyx_t_2, __pyx_int_14, __pyx_kp_s_Invalid_List_Type_TA_INVALID_LIS) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (PyDict_SetItem(__pyx_t_2, __pyx_int_15, __pyx_kp_s_Bad_Object_TA_BAD_OBJECT) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (PyDict_SetItem(__pyx_t_2, __pyx_int_16, __pyx_kp_s_Not_Supported_TA_NOT_SUPPORTED) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (PyDict_SetItem(__pyx_t_2, __pyx_int_5000, __pyx_kp_s_Internal_Error_TA_INTERNAL_ERROR) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (PyDict_SetItem(__pyx_t_2, __pyx_int_65535, __pyx_kp_s_Unknown_Error_TA_UNKNOWN_ERR) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
static CYTHON_INLINE TA_RetCode __Pyx_PyInt_As_TA_RetCode(PyObject *x) {
    ...
    if (likely(PyLong_Check(x))) {
        if (is_unsigned) {
            ...
            switch (Py_SIZE(x)) {
                case  0: return 0;
                case  1: __PYX_VERIFY_RETURN_INT(TA_RetCode, digit, ((PyLongObject*)x)->ob_digit[0]);
            }
 #endif
#endif
#if CYTHON_COMPILING_IN_CPYTHON
            ...
            if (sizeof(TA_RetCode) <= sizeof(unsigned long)) {
                __PYX_VERIFY_RETURN_INT(TA_RetCode, unsigned long, PyLong_AsUnsignedLong(x))
            } else if (sizeof(TA_RetCode) <= sizeof(unsigned PY_LONG_LONG)) {
                __PYX_VERIFY_RETURN_INT(TA_RetCode, unsigned PY_LONG_LONG, PyLong_AsUnsignedLongLong(x))
            }
        } else {
#if CYTHON_COMPILING_IN_CPYTHON && PY_MAJOR_VERSION >= 3
 #if CYTHON_USE_PYLONG_INTERNALS
            switch (Py_SIZE(x)) {
                case  0: return 0;
                case  1: __PYX_VERIFY_RETURN_INT(TA_RetCode,  digit, +(((PyLongObject*)x)->ob_digit[0]));
                case -1: __PYX_VERIFY_RETURN_INT(TA_RetCode, sdigit, -(sdigit) ((PyLongObject*)x)->ob_digit[0]);
            }
 #endif
#endif
            if (sizeof(TA_RetCode) <= sizeof(long)) {
                __PYX_VERIFY_RETURN_INT(TA_RetCode, long, PyLong_AsLong(x))
            } else if (sizeof(TA_RetCode) <= sizeof(PY_LONG_LONG)) {
                __PYX_VERIFY_RETURN_INT(TA_RetCode, PY_LONG_LONG, PyLong_AsLongLong(x))
            }
        }
        {
    ...
    if (likely(PyLong_Check(x))) {
        if (is_unsigned) {
            ...
            if (sizeof(TA_FuncUnstId) <= sizeof(unsigned long)) {
                ...
                __PYX_VERIFY_RETURN_INT(TA_FuncUnstId, unsigned PY_LONG_LONG, PyLong_AsUnsignedLongLong(x))
            }
        } else {
#if CYTHON_COMPILING_IN_CPYTHON && PY_MAJOR_VERSION >= 3
 #if CYTHON_USE_PYLONG_INTERNALS
            ...
            if (sizeof(TA_FuncUnstId) <= sizeof(long)) {
                ...
                __PYX_VERIFY_RETURN_INT(TA_FuncUnstId, PY_LONG_LONG, PyLong_AsLongLong(x))
            }
        }
        {
#if CYTHON_COMPILING_IN_PYPY && !defined(_PyLong_AsByteArray)
